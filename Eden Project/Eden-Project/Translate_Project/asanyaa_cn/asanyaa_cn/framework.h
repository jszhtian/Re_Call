...
public:
	...
	static void __fastcall FPK_Open(int a1, int null, LPCSTR lpFileName);
	static int __fastcall FPK_GetFileSize(int a1, int null);
	static void __fastcall FPK_Read(int a1, int null, LPVOID lpBuffer, DWORD nNumberOfBytesToRead);
private:
	static char fnm[MAX_PATH];
	static FILE* fp;
};
*/
namespace CFPK
{
	static BOOL __fastcall FPK_Open(int a1, int null, LPCSTR lpFileName);
	static int __fastcall FPK_GetFileSize(int a1, int null);
	static int __fastcall FPK_Read(int a1, int null, LPVOID lpBuffer, DWORD nNumberOfBytesToRead);

	static char fnm[MAX_PATH] = { 0 };
	static FILE* fp;
}