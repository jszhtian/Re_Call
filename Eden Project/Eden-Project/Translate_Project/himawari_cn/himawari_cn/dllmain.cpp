...
{
	GetFileNameAddr = (PVOID)(BaseAddr + 0x256445);
	GetNormalFileBufferAddr = (PVOID)(BaseAddr + 0x2549a4);
	GetMNGImageBufferAddr = (PVOID)(BaseAddr + 0x254902);
	ReadMNGImageFileAddr = (PVOID)(BaseAddr + 0x254909);
	AllocMemAddr = (PVOID)(BaseAddr + 0x2548E7);
