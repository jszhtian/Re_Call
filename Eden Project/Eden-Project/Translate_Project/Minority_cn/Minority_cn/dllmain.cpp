...
{
	const char* szWndName = "罪之光Rendezvous（深柑blossom）【胖次汉化组】 gkd.galkey.cc";
	...
	HANDLE hTemplateFile)
{
	...
	else if (strPazName == "bg.paz")
	{
		strNewName = strDirName + "cnbg.paz";
	}
	else
	{
...
PVOID pCreateFileA = (PVOID)(BaseAddr + 0x9ACE);
PVOID retnp = (PVOID)(BaseAddr + 0x9AD4);
...
{
	pShowMessage = (PVOID)(BaseAddr + 0x2223a);
	DetourTransactionBegin();
