...
#define DEBUG
const unsigned int opcode_name = 0x61;
const unsigned int opcode_text = 0x62;
const unsigned int opcode_select = 0x63;
const unsigned int opcode_voice1 = 0x46;
const unsigned int opcode_voice2 = 0x47;
...
#else
	char FileName[] = "wy_5_1226_a1_aoi.mes";
#endif
