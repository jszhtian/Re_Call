...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		...
		if (m_Expression->GetType() == Exp_NewClassExpression || m_Expression->GetType() == Exp_Function)
		{
			...
			TXT << ::indent(n) << expression_out(m_Expression, n) << std::endl << std::endl;
		}
		else
		{
			out << ::indent(n) << expression_out(m_Expression, n) << ';' << std::endl;
			TXT << ::indent(n) << expression_out(m_Expression, n) << ';' << std::endl;
		}
	}
...
private:
	void _generateCode( std::ostream& out, int n ) const
	{
		...
		TXT << "if (" << expression_out(m_Condition, n) << ')' << std::endl;
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		...
		else
		{
			...
			TXT << " = " << expression_out(m_Initialization, n) << ';' << std::endl;
		}
	}
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		if (!m_Expression)
		{
			...
			TXT << ::indent(n) << "return;" << std::endl;
		}
		else
		{
			out << ::indent(n) << "return " << expression_out(m_Expression, n) << ';' << std::endl;
			TXT << ::indent(n) << "return " << expression_out(m_Expression, n) << ';' << std::endl;
		}
	}
};
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		...
		TXT << ::indent(n) << "throw " << expression_out(m_Expression, n) << ';' << std::endl;
	}
};
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		if (m_Expression)
		{
			...
			TXT << ::indent(n) << "yield " << expression_out(m_Expression, n) << ';' << std::endl;
		}
		else
		{
			out << ::indent(n) << "yield;" << std::endl;
			TXT << ::indent(n) << "yield;" << std::endl;
		}
	}
};
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		...
		TXT << ::indent(n) << "continue;" << std::endl;
	}
};
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		...
		TXT << ::indent(n) << "while (" << expression_out(m_Condition, n) << ')' << std::endl;
		m_Block->GenerateCodeInBlock(out, n);
	}
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		...
		TXT << ::indent(n) << "switch(" << expression_out(m_Variable, n) << ')' << std::endl;
		m_Block->GenerateCodeInBlock(out, n);
	}
...
public:
	...
	virtual void GenerateCode( std::ostream& out, int n ) const
	{
		if (m_Value)
		{
			...
			TXT << ::indent(n) << "case " << expression_out(m_Value, n) << ':' << std::endl;
		}
		else
		{
			out << ::indent(n) << "default:" << std::endl;
			TXT << ::indent(n) << "default:" << std::endl;
		}
	}
};
