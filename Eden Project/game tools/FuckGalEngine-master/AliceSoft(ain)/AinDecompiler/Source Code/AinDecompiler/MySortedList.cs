...
{
    public class MySortedList<TValue> : IDictionary<int, TValue>
    {
        ...
        public MySortedList(IDictionary<int, TValue> dictionary)
        {
            foreach (var pair in dictionary)
            {
                ((ICollection<KeyValuePair<int, TValue>>)this).Add(pair);
            }
        }
        ...
        private void InsertAt(int index, int key, TValue value)
        {
        ...
        public int GetInsertIndex(int key)
        {
            int index = Util.BinarySearchFirstGreaterOrEqual<int>(this.keys, key);
            return index;
        }
        ...
        /// <param name="lookFor">The value in the list to look for</param>
        /// <returns>An index</returns>
        public int GetFetchIndex(int key)
        {
        ...
        public IEnumerable<TValue> ValuesInRange(int minimumKey, int maxmimumKey)
        {
            var keys = this.Keys;
        ...
        private IEnumerable<KeyValuePair<int, TValue>> enumerate()
        {
            for (int i = 0; i < keys.Count; i++)
            {
                yield return new KeyValuePair<int, TValue>(keys[i], values[i]);
            }
        }
    ...
    public static partial class Util
    {
        ...
        /// <param name="lookFor">The value in the list to look for</param>
        /// <returns>An index</returns>
        public static int BinarySearchFirstGreaterOrEqual(IList<int> list, int lookFor)
        {
            int firstIndex = 0;
            int lastIndex = list.Count;
            int currentIndex;
        ...
        /// <param name="lookFor">The value in the list to look for</param>
        /// <returns>An index</returns>
        public static int BinarySearchFirstLessOrEqual(IList<int> list, int lookFor)
        {
            int index = BinarySearchFirstGreaterOrEqual(list, lookFor);
            if (index >= 0 && index < list.Count)
            {
                int value = list[index];
                if (value > lookFor) return index - 1;
                return index;
            }
            if (index >= list.Count)
            {
