// exdieslib.cpp, v1.79 2013/07/18
// coded by asmodean
...
// pre-computed
static const unsigned long KEY_COUNT           = 18;
...
int main(int argc, char** argv) {
  if (argc < 3) {
    fprintf(stderr, "exdieslib v1.79 by asmodean\n\n");
    ...
    fprintf(stderr, "\tkey_index = 15 -> しろのぴかぴかお星さま (v2)\n");
    fprintf(stderr, "\tkey_index = 16 -> 神咒神威神楽 曙之光\n");
    fprintf(stderr, "\tkey_index = 17 -> BRAVA!! (v2)\n");
    return -1;
  }
