...
namespace Anz
{
	...
	template <class T> typename Anz::List<T>::ConstIterator begin(const Anz::List<T>& v) { return v.Begin(); }

	template <class T> typename Anz::List<T>::ConstIterator end(const Anz::List<T>& v) { return v.End(); }

	template <class T> typename Anz::List<T>::Iterator begin(Anz::List<T>& v) { return v.Begin(); }

	template <class T> typename Anz::List<T>::Iterator end(Anz::List<T>& v) { return v.End(); }
