...
namespace Anz
{
	...
	template <class T> typename Anz::Vector<T>::ConstIterator begin(const Anz::Vector<T>& v) { return v.Begin(); }

	template <class T> typename Anz::Vector<T>::ConstIterator end(const Anz::Vector<T>& v) { return v.End(); }

	template <class T> typename Anz::Vector<T>::Iterator begin(Anz::Vector<T>& v) { return v.Begin(); }

	template <class T> typename Anz::Vector<T>::Iterator end(Anz::Vector<T>& v) { return v.End(); }

	template <class T> typename Anz::PODVector<T>::ConstIterator begin(const Anz::PODVector<T>& v) { return v.Begin(); }

	template <class T> typename Anz::PODVector<T>::ConstIterator end(const Anz::PODVector<T>& v) { return v.End(); }

	template <class T> typename Anz::PODVector<T>::Iterator begin(Anz::PODVector<T>& v) { return v.Begin(); }

	template <class T> typename Anz::PODVector<T>::Iterator end(Anz::PODVector<T>& v) { return v.End(); }
