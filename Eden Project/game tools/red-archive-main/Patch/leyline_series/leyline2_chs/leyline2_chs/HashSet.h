...
namespace Anz
{
	...
	template <class T> typename Anz::HashSet<T>::ConstIterator begin(const Anz::HashSet<T>& v) { return v.Begin(); }

	template <class T> typename Anz::HashSet<T>::ConstIterator end(const Anz::HashSet<T>& v) { return v.End(); }

	template <class T> typename Anz::HashSet<T>::Iterator begin(Anz::HashSet<T>& v) { return v.Begin(); }

	template <class T> typename Anz::HashSet<T>::Iterator end(Anz::HashSet<T>& v) { return v.End(); }
