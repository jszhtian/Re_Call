...
namespace Anz
{
	...
	template <class T, class U> typename Anz::HashMap<T, U>::ConstIterator begin(const Anz::HashMap<T, U>& v) { return v.Begin(); }

	template <class T, class U> typename Anz::HashMap<T, U>::ConstIterator end(const Anz::HashMap<T, U>& v) { return v.End(); }

	template <class T, class U> typename Anz::HashMap<T, U>::Iterator begin(Anz::HashMap<T, U>& v) { return v.Begin(); }

	template <class T, class U> typename Anz::HashMap<T, U>::Iterator end(Anz::HashMap<T, U>& v) { return v.End(); }
