...
void PyECRYPT_init(void)
{
	...
	static char *str=
		...
		"*p17|"
		"@nm t=\"¥Ûåm\" s=omi_0003"
		"°∏§Ω§Ï§À°¢[æ≤∑Â'§∑§∫§ﬂ§Õ]§Ø§Û§‚§§§Î§∑£ø°π[np]"
		"@hide"
		"@move layer=0 path=(0,-360,255) time=200"
		"@wm"
		"@show"
		"*p18|"
		"Ã∆Õª§À√Á◊÷§¨≥ˆ§∆§≠§ø§Œ§«°¢Àº§Ô§∫ÓÜ§Ú…œ§≤§∆§∑§ﬁ§√§ø°£[np]"
		"@hide"
		"@bg storage=bg_12a st01bcdaa05=7.80"
		"@show"
		"@chr st01acdaa07"
		"*p19|"
		"ê{¡ß§»°¢“ïæÄ§¨∫œ§¶°£[np]"
		"@chr st01bcdaa15"
		"@dchr st01bcdaa17 delay=3107"
		"*p20|"
		"@nm t=\"ê{¡ß\" s=meg_0039"
		;
	u8 *p = (u8*)str;
