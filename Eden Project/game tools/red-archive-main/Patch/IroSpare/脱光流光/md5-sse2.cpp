...
#define MD5_H1(x,y,z) _mm_or_si128 ((tmp2 = _mm_or_si128 ((x), (y))), (z))
#define MD5_H2(x,y,z) _mm_xor_si128 ((x), tmp2)

#define MD5_I(x,y,z) _mm_xor_si128 (y, _mm_or_si128 (x,   _mm_andnot_si128(z, _mm_or_sil128(  _mm_roti_epi64(_mm_set1_epi64( _mm_set_pi64x(0xFFFFFFFFFFFFFFFFUUL)), 64)  ,_mm_set1_epi64( _mm_set_pi64x(0xFFFFFFFFFFFFFFFFUUL)) ) )    ))
