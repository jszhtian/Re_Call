...
#define SWAP32_SSE(v) _mm_or_si128( _mm_slli_epi32 (v, 24), _mm_or_si128( _mm_or_si128(_mm_and_si128(_mm_slli_epi32(v, 8), _mm_set1_epi32(0x00FF0000)), _mm_and_si128(_mm_srli_epi32(v, 8), _mm_set1_epi32(0x0000FF00))), _mm_srli_epi32 (v, 24)))
...
#define SWAP64_SSE(v) \
   _mm_or_si128(   \
   _mm_or_si128(    \
   _mm_or_si128( _mm_slli_epi64 (v, 56), _mm_and_si128 (_mm_slli_epi64 (v, 40), _mm_set1_epi64 (_mm_set_pi64x( 0x00FF000000000000ULL)))),   \
   _mm_or_si128( _mm_and_si128 (_mm_slli_epi64 (v, 24), _mm_set1_epi64 (_mm_set_pi64x( 0x0000FF0000000000ULL))), _mm_and_si128 (_mm_slli_epi64 (v,  8), _mm_set1_epi64 (_mm_set_pi64x( 0x000000FF00000000ULL))))  \
   )   \
   ,   \
   _mm_or_si128(   \
   _mm_or_si128( _mm_and_si128 (_mm_srli_epi64 (v,  8), _mm_set1_epi64 (_mm_set_pi64x( 0x00000000FF000000ULL))), _mm_and_si128 (_mm_srli_epi64 (v, 24), _mm_set1_epi64 (_mm_set_pi64x( 0x0000000000FF0000ULL))))  \
   ,   \
   _mm_or_si128( _mm_and_si128 (_mm_srli_epi64 (v, 40), _mm_set1_epi64 (_mm_set_pi64x( 0x000000000000FF00ULL))), _mm_srli_epi64 (v, 56))  \
   ))
