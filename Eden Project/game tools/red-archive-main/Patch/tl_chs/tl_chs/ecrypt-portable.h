...
#define U16V(v) ((uint16_t)(v) & U16C(0xFFFF))
#define U32V(v) ((uint32_t)(v) & U32C(0xFFFFFFFF))
#define U64V(v) ((uint64_t)(v) & U64C(0xFFFFFFFFFFFFFFFF))
...
#define U8TO16_LITTLE(p) U16TO16_LITTLE(((uint16_t*)(p))[0])
#define U8TO32_LITTLE(p) U32TO32_LITTLE(((uuint32_t*)(p))[0])
#define U8TO64_LITTLE(p) U64TO64_LITTLE(((uint64_t*)(p))[0])

#define U8TO16_BIG(p) U16TO16_BIG(((uint16_t*)(p))[0])
#define U8TO32_BIG(p) U32TO32_BIG(((uint32_t*)(p))[0])
#define U8TO64_BIG(p) U64TO64_BIG(((uint64_t*)(p))[0])

#define U16TO8_LITTLE(p, v) (((uint16_t*)(p))[0] = U16TO16_LITTLE(v))
#define U32TO8_LITTLE(p, v) (((uint32_t*)(p))[0] = U32TO32_LITTLE(v))
#define U64TO8_LITTLE(p, v) (((uint64_t*)(p))[0] = U64TO64_LITTLE(v))

#define U16TO8_BIG(p, v) (((uint16_t*)(p))[0] = U16TO16_BIG(v))
#define U32TO8_BIG(p, v) (((uint32_t*)(p))[0] = U32TO32_BIG(v))
#define U64TO8_BIG(p, v) (((uint64_t*)(p))[0] = U64TO64_BIG(v))
