...
HRESULT WINAPI FriendToLoverHook::LoadFileSystem()
{
	VMProtectBeginVirtualization("000");

	if (SystemFile.Open(L"FTLHD.chs", WinFile::FileRead) != S_OK)
		return S_FALSE;
	...
	{
		MessageBoxW(NULL, L"[文件系统]这特么是啥78封包", BaseAppName, MB_OK);
		ExitProcess(-1);
	}
...
#if 0
HANDLE WINAPI FriendToLoverHook::CreateFileBoxedA(LPCSTR lpFileName)
{
