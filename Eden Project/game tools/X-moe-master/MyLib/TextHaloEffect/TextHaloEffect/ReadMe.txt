================================================================================
    MICROSOFT 基础类库： TextHaloEffect 项目概述
===============================================================================

应用程序向导已为您创建了此 TextHaloEffect 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 TextHaloEffect 应用程序的每个文件的内容摘要。

TextHaloEffect.vcproj
...
TextHaloEffect.h
    ...
    CTextHaloEffectApp 应用程序类。

TextHaloEffect.cpp
    这是包含应用程序
    类 CTextHaloEffectApp 的主应用程序源文件。
...
res\TextHaloEffect.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 TextHaloEffect.rc 中。

res\TextHaloEffect.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 TextHaloEffect.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

TextHaloEffectDoc.h、TextHaloEffectDoc.cpp - 文档
    这些文件包含 CTextHaloEffectDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CTextHaloEffectDoc::Serialize）。
TextHaloEffectView.h、TextHaloEffectView.cpp - 文档视图
    这些文件包含 CTextHaloEffectView 类。
    CTextHaloEffectView 对象用于查看 CTextHaloEffectDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 TextHaloEffect.pch 的预编译头文件 (PCH)
