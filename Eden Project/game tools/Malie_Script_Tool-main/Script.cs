...
namespace Malie_Script_Tool
{
    ...
    class Script
    {
        ...
        void Dump()
        {
            ...
            {
                Debug.WriteLine($"{"SYMBOL",-12} {item.Name,-32} {item.Type:X8} {item.field_8:X8} {item.field_14:X8}");
            }
                ...
                while (stream.Position < stream.Length)
                {
                    ...
                    switch (code)
                    {
                        ...
                        case 0x2D:
                        {
                            ...
                            if (index >= 0 && index < _functions.Count)
                            {
                                Console.WriteLine(_functions.Count);
        ...
        string GetMessage(uint index)
        {
            ...
            return _encoding.GetString(_seg_message, entry.Offset, entry.Length);
        }
